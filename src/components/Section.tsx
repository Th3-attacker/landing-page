...
export const Section: React.FC = () => {
  return (
    <div className="px-32 py-10 text-white text-center mx-auto">
      <div className="w-1/2 mx-auto space-y-6 mb-10">
        <h1 className="text-7xl ">Features that work for your future.</h1>
        <p className="text-md">
